...
abstract class BaseAttachPopup<B : ViewDataBinding, VM : BaseViewModel>(activity: AppCompatActivity) :
    AttachPopupView(activity), IBasePopup {
    ...
    override fun initPopupContent() {
        ...
        mBinding = DataBindingUtil.bind(popupImplView)
            ?: throw NullPointerException("XmxAttachPopup mBinding is Null!")
